...
urlpatterns = [
    ...
    path('approve-teacher/<str:pk>', views.approve_teacher_view, name='approve-teacher'),
    path('delete-teacher/<str:pk>', views.delete_teacher_view, name='delete-teacher'),
    path('delete-teacher-from-school/<str:pk>', views.delete_teacher_from_school_view,
         name='delete-teacher-from-school'),
    path('update-teacher/<str:pk>', views.update_teacher_view, name='update-teacher'),
    ...
    path('delete-student-from-school/<str:pk>', views.delete_student_from_school_view,
         name='delete-student-from-school'),
    path('delete-student/<str:pk>', views.delete_student_view, name='delete-student'),
    path('update-student/<str:pk>', views.update_student_view, name='update-student'),
    path('admin-approve-student', views.admin_approve_student_view, name='admin-approve-student'),
    path('approve-student/<str:pk>', views.approve_student_view, name='approve-student'),
